...
class FrameViewer(Gtk.Window):
    ...
    def _showframe(self, imgdata):
        ...
        if (self._start != None):
            ...
            GLib.idle_add(self.set_title, "{:.1f} fps / {:.1f} kb / {:.1f} prediction / {:.1f} angle".format(fps, len(imgdata)/1000, (inference.sum/5),((inference_s.sum2)/5)*57.3)) #inference_s.sum2/3
        ...
        try:
            ...
            if (pix != None):
                ...
                [prediction , steering_angle] = model(image).numpy()[0,0]
...
if __name__ == '__main__':
    ...
    #cf_tx1 = Client(('localhost', 6000), authkey=b'crazyflie')
